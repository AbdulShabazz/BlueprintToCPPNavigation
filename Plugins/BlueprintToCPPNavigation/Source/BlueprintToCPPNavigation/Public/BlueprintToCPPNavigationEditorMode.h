...
#include "BlueprintToCPPNavigationEditorMode.generated.h"
 ...
 */
UCLASS()
class UBlueprintToCPPNavigationEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_BlueprintToCPPNavigationEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UBlueprintToCPPNavigationEditorMode();
	virtual ~UBlueprintToCPPNavigationEditorMode();
