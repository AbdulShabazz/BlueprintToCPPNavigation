...
#include "BlueprintToCPPNavigationInteractiveTool.generated.h"
 ...
 */
UCLASS()
class BLUEPRINTTOCPPNAVIGATION_API UBlueprintToCPPNavigationInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS(Transient)
class BLUEPRINTTOCPPNAVIGATION_API UBlueprintToCPPNavigationInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class BLUEPRINTTOCPPNAVIGATION_API UBlueprintToCPPNavigationInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UBlueprintToCPPNavigationInteractiveToolProperties> Properties;
